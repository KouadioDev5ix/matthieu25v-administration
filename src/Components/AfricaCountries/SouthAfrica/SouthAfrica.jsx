...
export default function SouthAfrica() {
  const [areaData, setAreaData] = useState([
    {
      id: 1,
      tilte: "Mthatha Assembly",
      pastorName: "Sanele Jange",
      constact: "+27 79 59 90 80",
      locatedAt: "sONDELA QWEQWE",
    },

    {
      id: 2,
      tilte: "Thembisa Assembly",
      pastorName: "Anthony Nuobe",
      constact: "+27 79 59 90 80",
      locatedAt: "Lorem ipsum dolor si ",
    },
    {
      id: 3,
      tilte: "Pretoria Assembly",
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Afrique du sud</h1>
        <button
